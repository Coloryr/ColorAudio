...
static lv_font_manager_t *font_manager = NULL;

void load_font()
{
    /* Create font manager, with 8 fonts recycling buffers */
    font_manager = lv_font_manager_create(8);

    LV_LOG_USER("load font: %s", TTF_FONT);

    /* Add font path mapping to font manager */
    lv_font_manager_add_src_static(font_manager,
                                   "MiSans",
                                   TTF_FONT,
    ...
    font_18 = lv_font_manager_create_font(font_manager,
                                          "MiSans",
                                          LV_FREETYPE_FONT_RENDER_MODE_BITMAP,
                                          18,
                                          LV_FREETYPE_FONT_STYLE_NORMAL,
    ...
    font_22 = lv_font_manager_create_font(font_manager,
                                          "MiSans",
                                          LV_FREETYPE_FONT_RENDER_MODE_BITMAP,
                                          22,
                                          LV_FREETYPE_FONT_STYLE_NORMAL,
    ...
    font_32 = lv_font_manager_create_font(font_manager,
                                          "MiSans",
                                          LV_FREETYPE_FONT_RENDER_MODE_BITMAP,
                                          32,
                                          LV_FREETYPE_FONT_STYLE_NORMAL,
