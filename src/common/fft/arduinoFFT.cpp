...
template <typename T>
void ArduinoFFT<T>::complexToMagnitude(void) const
{
...
template <typename T>
void ArduinoFFT<T>::dcRemoval(void) const
{
...
template <typename T>
T ArduinoFFT<T>::majorPeak(void) const
{
  return majorPeak(this->_vReal, this->_samples, this->_samplingFrequency);
}

template <typename T>
void ArduinoFFT<T>::majorPeak(T *f, T *v) const
{
...
template <typename T>
T ArduinoFFT<T>::majorPeakParabola(void) const
{
  T freq = 0;
...
template <typename T>
void ArduinoFFT<T>::swap(T *a, T *b) const
{
  T temp = *a;
  *a = *b;
  *b = temp;
...
template <typename T>
float ArduinoFFT<T>::sqrt_internal(float x) const
{
...
template <typename T>
double ArduinoFFT<T>::sqrt_internal(double x) const
{
